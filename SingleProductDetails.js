...
const SingleProductDetails = () => {
    ...
    const onSubmit = data => {
        ...
        const orderData = { productId: _id, productName, productImg1, ...data, quantity, productNewPrice, totalAmount: quantity * productNewPrice, orderDate: orderDate.toLocaleDateString() }
